...
//=========================================================================================================================
//Task 3. Управляем роботом, врезаемся в стены
//=========================================================================================================================
...
public:
	...
	~Robot() {}
	void Move(int _x, int _y)  //параметры - указание на сколько единиц нужно переместиться по оси х или оси у (относительно текущей позиции)
	{
		if ((_x > 0) && (_y > 0)) //робот движется по диагонали а не на прилежащую клетку
